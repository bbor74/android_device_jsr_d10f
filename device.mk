...
# Sensors     $(LOCAL_PATH)/configs/sensors/_hals.conf:system/vendor/etc/sensors/_hals.conf 
#    $(LOCAL_PATH)/configs/init.qcom-sensor.sh:system/vendor/bin/init.qcom-sensor.sh 
